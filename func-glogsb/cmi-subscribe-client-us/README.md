# cmi-subscribe-client-us

`cmi-subscribe-client-us` processes US client messages from Service Bus and forwards them to Integration Builder.

## Trigger

- Type: Service Bus trigger
- Topic setting: `topicClientUS`
- Subscription setting: `subClientUS`
- Connection: `us_sb`
