# cmi-subscribe-matter-us

`cmi-subscribe-matter-us` processes US matter messages from Service Bus and forwards them to Integration Builder.

## Trigger

- Type: Service Bus trigger
- Topic setting: `topicMatterUS`
- Subscription setting: `subMatterUS`
- Connection: `us_sb`
